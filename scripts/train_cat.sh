...
python train.py \
	--gpu_ids $gpu --seed 0 --loadSize 299 --fineSize 299 \
	--name Xception123_cat-FF-DF-s299-b64-lr5e5 --save_epoch_freq 3 \
 	--real_im_path $dset/original \
 	--fake_im_path $dset/DF \
...
python train.py \
	--gpu_ids $gpu --seed 0 --loadSize 299 --fineSize 299 \
	--name Xception123_cat-FF-F2F-s299-b64-lr5e5 --save_epoch_freq 3 \
 	--real_im_path $dset/original \
 	--fake_im_path $dset/F2F \
	--which_model_netD xception_block3_cat_extra1_extra2_extra3 \
	--model patch_discriminator_cat \
...
python train.py \
	--gpu_ids $gpu --seed 0 --loadSize 299 --fineSize 299 \
	--name Xception123_cat-FF-FS-s299-b64-lr5e5 --save_epoch_freq 3 \
 	--real_im_path $dset/original \
 	--fake_im_path $dset/FS \
	--which_model_netD xception_block3_cat_extra1_extra2_extra3 \
	--model patch_discriminator_cat \
...
python train.py \
	--gpu_ids $gpu --seed 0 --loadSize 299 --fineSize 299 \
	--name Xception123_cat-FF-NT-s299-b64-lr5e5 --save_epoch_freq 3 \
 	--real_im_path $dset/original \
 	--fake_im_path $dset/NT \
	--which_model_netD xception_block3_cat_extra1_extra2_extra3 \
	--model patch_discriminator_cat \
